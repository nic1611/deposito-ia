...
# título
st.title("Indicação de Investimento em Startup - By Nicolas SOffi")
...
Indice_Faturamento = st.sidebar.number_input("Indice de Faturamento", value=data.Indice_Faturamento.mean())
Indice_Setorial = st.sidebar.number_input("Projecao Setorial", value=data.Indice_Setorial.mean())
Indice_Inovacao = st.sidebar.number_input("Indice de Inovacao", value=data.Indice_Inovacao.mean())
Indice_Falencias = st.sidebar.number_input("Indice de Falencias", value=data.Indice_Falencias.mean())
Indice_Expertise_Estrategica = st.sidebar.number_input("Indicador de Expertise Estrategica", value=data.Indice_Expertise_Estrategica.mean())
